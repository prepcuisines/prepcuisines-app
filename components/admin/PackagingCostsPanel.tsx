...
const GROUPS: { title: string; keys: string[] }[] = [
  ...
  { title: 'Stoke-on-Trent (per order)', keys: ['stoke_bag'] },
  { title: 'Nationwide boxes (per order, incl. insulation + ice packs)', keys: ['box_small', 'box_medium', 'box_large'] },
  { title: 'Shipping label (per order)', keys: ['shipping_label'] },
  { title: 'Weekly overhead (not per-order)', keys: ['gloves_sunday', 'gloves_wednesday', 'tape', 'drivers_stoke'] },
]

export default function PackagingCostsPanel() {
  ...
  return (
    <div style={{ maxWidth: 720, padding: '0 0 100px' }}>
      <p style={{ color: '#666', fontSize: 14, marginBottom: 20 }}>
        What packaging materials actually cost you. Edit any figure as you find cheaper suppliers -
        Meal Costs and Delivery Costs update automatically.
      </p>
