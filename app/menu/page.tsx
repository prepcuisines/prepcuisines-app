...
export default async function Page() {
  ...
  for (const w of dedupedWindows) {
    const { data: items } = await supabase
      ...
      .select('week_in_rotation, menu_items(id, name, description, price, category, allergens, image_url, compare_at_price, promo_label, calories, protein_g, carbs_g, fat_g)')
