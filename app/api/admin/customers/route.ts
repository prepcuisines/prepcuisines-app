...
export async function GET(req: NextRequest) {
  ...
  const { data: customers, error } = await supabase
    ...
    .select(
      'id, full_name, email, phone, house_number, street, postcode, subscription_status, subscription_cancelled_at, orders_completed, standing_plan_size, second_plan_size, standing_delivery_day, second_delivery_day, deliveries_per_week, skip_next_order, created_at, marketing_consent'
    )
